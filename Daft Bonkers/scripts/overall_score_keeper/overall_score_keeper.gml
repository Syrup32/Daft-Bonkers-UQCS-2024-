...
function victory_check(){
	...
	{
		instance_create_layer(room_width/2,room_height/2,"Instances",obj_tie_game);
		call_later(4, time_source_units_seconds, back_to_main);
	}
	else if global.player2_victories = 2
	{
		instance_create_layer(room_width/2,room_height/2,"Instances",obj_red_win);
		call_later(4, time_source_units_seconds, back_to_main);
	}
	else if global.player1_victories = 2
	{
		instance_create_layer(room_width/2,room_height/2,"Instances",obj_blue_win);
		call_later(4, time_source_units_seconds, back_to_main);
	}
	else
	{
